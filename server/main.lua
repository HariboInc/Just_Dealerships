...
function CheckFrameworkVersion()
    PerformHttpRequest("https://raw.githubusercontent.com/HariboInc/Just_Dealerships/main/version.txt", function(err, text, headers)
        if string.match(text, version) then
            print(" ")
            print("--------- ^4JUST_DEALERSHIPS VERSION^7 ---------")
            print("Just_Dealerships ^2is up to date^7 and ready to go!")
            print("Running on Version: ^2" .. version .."^7")
            print("^4https://github.com/HariboInc/Just_Dealerships^7")
            print("--------------------------------------------")
            print(" ")
        else
          print(" ")
          print("--------- ^4JUST_DEALERSHIPS VERSION^7 ---------")
          print("Just_Dealerships ^1is not up to date!^7 Please update!")
